...
export const CompactQuestionCardEditable: React.FC<
  CompactQuestionCardEditableProps
> = ({ className, category, tags, maxOptions = 6, bare = false }) => {
  const {
    watch,
    setValue,
    formState: { errors },
  ...
  const content = (
    <>
              ...
              <div
                ...
                className={clsx(
                  ...
                  errors.options?.[index]
                    ? "bg-destructive/10"
                    : "bg-background/20 hover:bg-background/90 focus:bg-background"
                )}
      ...
      {!bare && ownerAnswerIndex !== undefined && options[ownerAnswerIndex] && (
